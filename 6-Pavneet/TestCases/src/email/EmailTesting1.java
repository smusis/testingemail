...
public class EmailTesting1 {
	...
	public static void getNamesNEmailsRemaining() throws IOException, InterruptedException{
		final BufferedReader br=new BufferedReader(new FileReader("E:/Research Projects/FSE 2016/EmailCommits/Top1000Testers.csv"));
		...
		for(Map.Entry<String, HashSet<String>> entry: remToSend.entrySet()){
			try {
				...
				message.setContent("Dear " +name+","+
						...
						+ "good test cases/suites, how practitioners write test cases, what are issues practitioners "
						+ "commonly face related to writing and maintaining test cases. "
						+ "<br><br>"

						+ "I analyzed your commit history and find that you have contributed to project(s) on GitHub such as "
						+ projects +" and in more than "+commits+" you have added or edited a test file. "
						+ "Being an active member in the open-source community, I thought "
						...
						+ "in particular to the test cases you have added/edited.<br><br>"
				...
				PrintWriter writer=new PrintWriter(new BufferedWriter(new FileWriter("E:/Research Projects/FSE 2016/Emails/ExceptionCoding1.csv",true)));
