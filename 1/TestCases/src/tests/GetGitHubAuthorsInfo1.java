...
public class GetGitHubAuthorsInfo1 {
	...
	public static void getAuthorInfo() throws IOException, InterruptedException{
		...
		final File folder = new File("E:/Research Projects/FSE 2016/TestCommits1");
...
//				}
		...
		PrintWriter writeTestCommits = new PrintWriter(new BufferedWriter(new FileWriter("E:/Research Projects/FSE 2016/testers_TestCommits_info1.csv")),true);
		...
		PrintWriter writeTestCommitFiles =  new PrintWriter(new BufferedWriter(new FileWriter("E:/Research Projects/FSE 2016/testers_TestCommitFiles_info1.csv")),true);
