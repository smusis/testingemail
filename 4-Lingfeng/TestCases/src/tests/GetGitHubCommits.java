...
public class GetGitHubCommits {
	...
	public static void getEmails() throws IOException, InterruptedException{
		...
		try (BufferedReader br = new BufferedReader(new FileReader("E:\\Research Projects\\FSE 2016\\projects_final.csv"))) {
			...
			while ((line = br.readLine()) != null) {
				...
				try{
					...
					project=projectSplit[3]+"/"+projectSplit[4];
				...
				//				}
					...
					Thread.sleep(3600000);
					PrintWriter writeCommits = new PrintWriter(new BufferedWriter(new FileWriter("E:\\Research Projects\\FSE 2016\\Projects_RunAgain.txt",true)));
					writeCommits.write(project);
					writeCommits.close();
					continue;
				}
				//				finally{
		...
		PrintWriter writeCommits = new PrintWriter("E:\\Research Projects\\FSE 2016\\testers_Commits_info1.csv");
		...
		PrintWriter writeTestCommits = new PrintWriter("E:\\Research Projects\\FSE 2016\\testers_TestCommits_info1.csv");
		...
		PrintWriter writeTestCommitFiles = new PrintWriter("E:\\Research Projects\\FSE 2016\\testers_TestCommitFiles_info1.csv");
